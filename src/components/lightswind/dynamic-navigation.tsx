...
export const DynamicNavigation = ({
  ...
  const defaultThemeStyles = {
    ...
    border: "border",
    text: textColor || "dark:text-white text-black", // Use provided or default white
    highlight: highlightColor || "bg-foreground/10 dark:bg-gray-900", // Use provided or default white/10
        ...
        {links.map((link) => (
          ...
          >
            <a
              ...
              onClick={(e) => {
                e.preventDefault();
                handleLinkClick(link.id,link.href, e);
              }}
